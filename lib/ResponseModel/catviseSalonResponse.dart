...
class CatSalonData {
  ...
  String? imagePath;
  String? ownerName;
  CategoreWiseSalonOwnerDetails? ownerDetails;
  ...
  CatSalonData.fromJson(Map<String, dynamic> json) {
    ...
    ownerDetails = json['ownerDetails'] != null
        ? new CategoreWiseSalonOwnerDetails.fromJson(json['ownerDetails'])
        : null;
  }
...
class CategoreWiseSalonOwnerDetails {
  int? id;
  String? name;
  String? image;
  String? email;
  ...
  CategoreWiseSalonOwnerDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    image = json['image'];
    email = json['email'];
